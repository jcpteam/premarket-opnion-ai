...
exports.environmentVariablesExample = exports.frontendIntegrationExample = void 0;
exports.setupAuthIntegration = setupAuthIntegration;
...
async function setupAuthIntegration() {
    ...
    const authRouter = (0, auth_routes_1.createAuthRouter)({ authService });
    ...
    app.get('/api/admin', authMiddleware.authenticate, authMiddleware.requireAdmin, (req, res) => {
        res.json({
...
exports.frontendIntegrationExample = `
...
`;
exports.environmentVariablesExample = `
...
//# sourceMappingURL=auth-integration.example.js.map